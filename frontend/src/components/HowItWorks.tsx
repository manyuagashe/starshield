      ...
      content: (
        <div className="space-y-3 w-full max-w-3xl">
          <div className="text-center space-y-2 relative">
            ...
            <h3 className="text-lg font-bold glow-primary">
              Near Earth Object Defense System
            </h3>
            <p className="text-sm text-muted-foreground max-w-md mx-auto">
              A real-time monitoring system that tracks asteroids and comets
        ...
        <div className="space-y-3 w-full max-w-3xl">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-3 rounded-lg border border-blue-500/30">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <div>
                • <strong>Purpose:</strong> Comprehensive catalog of all
                potentially hazardous near-Earth objects
              </div>
              <div>
                • <strong>Features:</strong> Search, filter, and sort asteroids
